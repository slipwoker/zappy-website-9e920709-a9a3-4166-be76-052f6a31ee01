document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && value === '') {
        setFieldError(field, customMessage || field.getAttribute('data-required-message') || 'This field is required.');
        return false;
      }
      ...
      if (type === 'email' || name.includes('email')) {
        if (!isValidEmail(value)) {
          setFieldError(field, field.getAttribute('data-email-message') || 'Please enter a valid email address.');
          return false;
        }
      }
      ...
      if (type === 'tel' || name.includes('phone') || name.includes('tel')) {
        if (!isValidPhone(value)) {
          setFieldError(field, field.getAttribute('data-phone-message') || 'Please enter a valid phone number.');
          return false;
        }
      }
      ...
      if (type === 'url') {
        try {
          ...
          setFieldError(field, field.getAttribute('data-url-message') || 'Please enter a valid URL.');
          return false;
        }
      }

      if (minLength && value.length < parseInt(minLength, 10)) {
        setFieldError(field, field.getAttribute('data-minlength-message') || 'Minimum length is ' + minLength + ' characters.');
        return false;
      }

      if (maxLength && value.length > parseInt(maxLength, 10)) {
        setFieldError(field, field.getAttribute('data-maxlength-message') || 'Maximum length is ' + maxLength + ' characters.');
        return false;
      }

      if (field.type === 'checkbox' && field.hasAttribute('required') && !field.checked) {
        setFieldError(field, customMessage || 'This checkbox is required.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9e920709-a9a3-4166-be76-052f6a31ee01',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9e920709-a9a3-4166-be76-052f6a31ee01';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9e920709-a9a3-4166-be76-052f6a31ee01';
